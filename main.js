...
function modelLoaded() {
    console.log("Kise ko koi fark nihi parta");
}
function gotPoses(results) {
    if (results.length > 0) {
        ...
        console.log("left_wristx =" + leftWristX+ "left_wrisy =" + leftWristY);
        rightWristX = results[0].pose.rightWrist.x;
        rightWristY = results[0].pose.rightWrist.y;
        console.log("right_wristx =" + rightWristX+ "right_wrisy =" + rightWristY);
    }
}
function draw() {
